...
const MarketingPage = () => {
    return (
        <div className="flex items-center justify-center flex-col">
            <div className={cn("flex items-center justify-center flex-col px-4 md:px-0",headingFont.className)}>
                ...
                <div className=" bg-gradient-to-r from-fuchsia-600 to-pink-500  px-4 p-2 rounded-md pb-4 w-fit text-3xl md:text-5xl text-white">
                    Work Forward
                </div>
            </div>
